    ...
    async ({ noiseModel, noiseStrength }) => {
      ...
      try {
        ...
        if (res && res.success) {
          ...
          throw new Error(
            res?.error ||
              "Failed to simulate noisy evolution."
          );
        }
      } catch (err) {
        console.error(
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-app-text-muted)] mt-0.5">
              Inspect quantum state amplitudes, subsystem entanglement, and Bloch coordinates at each operation.
            </p>
      ...
      {!challengeMode &&
        showNoiseLab && (
          <NoiseLabControls
            ...
            divergenceSummary={
              noisyTimeline?.divergenceSummary
            }
          />
        )}
      ...
      {isStale && (
        <div className="px-4 py-2.5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-200 text-xs flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>
              Circuit structure was modified. The timeline below reflects the previous state before edits.
            </span>
      ...
      {!challengeMode &&
        ...
        currentNoisyStep && (
          <NoiseDivergencePanel
            ...
            noisyTimelineId={
              noisyTimeline?.noisyTimelineId
            }
            divergenceSummary={
              noisyTimeline?.divergenceSummary
            }
            noiseModel={
              activeNoiseConfig?.noiseModel
            }
            noiseStrength={
              activeNoiseConfig?.noiseStrength
            }
          />
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <PairedProbabilityHeatmap
              ...
              noisyProbabilities={
                currentNoisyStep.quantumProbabilities ||
                {}
              }
              readoutProbabilities={
                currentNoisyStep.readoutObservedProbabilities ||
                null
              }
              noiseModel={
                activeNoiseConfig?.noiseModel
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="app-glass rounded-2xl p-5 border border-[var(--color-app-border)] flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="relative h-64 w-full rounded-xl overflow-hidden bg-black/40 border border-[var(--color-app-border)]">
